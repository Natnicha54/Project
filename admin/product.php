...
<body>
	...
	<header class="header-section header-normal">
		<div class="container-fluid">
			<!-- logo -->
			<div class="site-logo">
				<img  src="../image/SHOESHI.png" alt="logo" width="200" height="55">
			</div>
			<!-- responsive -->
	...
	<div class="page-area product-page spad">
		<div class="container">
            ...
            <center><a href="../insert.php" class="btn btn-dark my-2">เพิ่มข้อมูลสินค้า</a></center> <br>
			<div class="row">
            ...
            <div class="col-lg-3">
					...
					<div class="product-item">
						...
						<div class="product-info">
							...
							<a href="../update.php?id=<?=$data['p_id'];?>" class="site-btn btn-line">แก้ไข</a> <br>
                            <p><a href="delete.php?id=<?=$data['p_id'];?>" class="site-btn btn-line">ลบ</a>
