...
<body>
	...
	<header class="header-section">
		<div class="container-fluid">
			<!-- logo -->
			<div class="site-logo"><img src="image/SHOESHI.png" width="180" height="55"></div>
			<!-- responsive -->
			<div class="nav-switch">
				<i class="fa fa-bars"></i>
			</div>
			<div class="header-right">
				<a href="cart.php" class="card-bag"><img src="#" alt=""></a>
				<a href="login.php" class="login"> <img src="image/icons/Icon.png" alt=""></a>
			</div>
			<!-- site menu -->
			<ul class="main-menu">
				<li><a href="#"></a></li>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="featured-item">
						...
						<a href="product.php" class="site-btn">see more</a>
					</div>
				</div>
				<div class="col-md-6">
            ...
            <div class="col-lg-3">
					...
					<div class="product-item">
						...
						<div class="product-info">
							...
							<a href="pleaselogin.php?id=<?=$data['p_id'];?>" class="site-btn btn-line">ADD TO CART</a>
